Shader "Unity Shaders Book/Chapter 10/Fresnel Empricial" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                fixed3 fresnel = max(0, min(1, _FresnelBias + _FresnelScale * pow(1 - dot(worldViewDir, worldNormal), _FresnelPower)));
    ...
    // CustomEditor "Fresnel Empricial Editor Script Name"
}
